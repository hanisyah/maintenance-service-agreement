...
class CreateTrainReliabilityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('train_reliability', function (Blueprint $table) {
            $table->increments('id_train_reliability');
    ...
    {
        Schema::dropIfExists('train_reliability');
    }
}
