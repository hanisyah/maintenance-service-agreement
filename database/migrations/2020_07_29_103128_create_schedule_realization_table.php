...
class CreateScheduleRealizationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('schedule_realization', function (Blueprint $table) {
            $table->increments('id_schedule_realization');
    ...
    {
        Schema::dropIfExists('schedule_realization');
    }
}
